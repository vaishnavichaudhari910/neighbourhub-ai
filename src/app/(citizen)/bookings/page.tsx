...
import {
  Clock, CheckCircle, XCircle, CalendarCheck, TrendingUp, Star
} from "lucide-react"
              ...
              <div key={booking.id}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Review section — COMPLETED bookings sathi */}
                      ...
                      <div className="mt-3 pt-3 border-t border-border">
                        {booking.review ? (
                          ...
                          <Button size="sm" variant="outline"
                            className="gap-2 text-yellow-600 border-yellow-300 hover:bg-yellow-50 dark:hover:bg-yellow-950/30"
